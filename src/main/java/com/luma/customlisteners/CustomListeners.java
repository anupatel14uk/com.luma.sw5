...
public class CustomListeners implements ITestListener {
    ...
    @Override
    public void onTestSuccess(ITestResult iTestResult) {//for pass ScreenShort
    ...
    @Override
    public void onTestFailure(ITestResult iTestResult) {//fpr failed and index one as well
